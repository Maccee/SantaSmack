const Arrow = ({ isVelocityPositive, style }) => {
  const fillColor = isVelocityPositive ? "#bd2828" : "#0cd366";
  return (
    <svg
      style={style}
      height="800px"
    ...
    >
      ...
      <g id="Layer_1">
        ...
        <g className="st1">
          <path
            className="st2"
            d="M49.5,33.9L35.3,15.7c-1.8-2.3-4.7-2.3-6.5,0L14.5,33.9c-1.8,2.3-1,4.1,1.7,4.1H24v12c0,2.2,1.8,4,4,4h8
    ...
    <>
      ...
      {isHit && (
        <div className="distance" style={distanceStyle}>
          {isOffScreen && (
            <Arrow
              isVelocityPositive={verticalVelocityRef.current > 0}
              style={arrowStyle}
            />
          )}
          <p>{distance}</p>
